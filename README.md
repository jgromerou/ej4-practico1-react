# Ejercicio 4 del TP1: Lista de Tareas - React ![React Icon](./src/assets/react.svg)
...
[Netlify](https://ej4-tp1-react-rollingcode-romerouro.netlify.app/)
...
1.  **Clona el repositorio:** En tu línea de comandos, ejecuta el siguiente comando para clonar el repositorio:
    ...
    ```
    git clone https://github.com/jgromerou/ej4-practico1-react.git
    ```
